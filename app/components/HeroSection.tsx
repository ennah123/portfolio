   ...
   <div className="min-h-screen flex items-center justify-center w-full px-4 py-8 relative overflow-hidden  lg:mt-0 md:mt-0 mt-10 dark:bg-c2">
    ...
    <div className="absolute inset-0 flex justify-center">
      ...
      <div className="relative w-1/3 flex justify-between">
        ...
        <div className="w-[2px] h-full bg-gradient-to-b from-transparent via-c2 dark:via-white to-transparent animate-vertical-beam animation-delay-300"></div>
        ...
        <div className="w-[2px] h-full bg-gradient-to-b from-transparent via-c2 dark:via-white to-transparent animate-vertical-beam animation-delay-900"></div>
      ...
      <div className=""></div>
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-10 max-w-6xl ">
          <div className="text-center lg:text-left max-w-md lg:max-w-lg backdrop-blur-sm p-10! rounded-lg">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl dark:text-zinc-200 text-c2 font-extrabold">
              FULL-STACK
            </h1>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl dark:text-zinc-200 text-c2 font-extrabold mt-2">
              DEVELOPER
            </h1>
          <div className="w-24 h-1 bg-c1 mx-auto lg:mx-0 mt-4"></div>
          
          <p className="mt-6 lg:mt-10 dark:text-gray-200 text-gray-600 leading-relaxed text-sm sm:text-base">
          ...
          <div className="mt-8 lg:mt-12 flex flex-wrap gap-3 justify-center lg:justify-start">
            <i className="devicon-react-original dark:text-gray-200 text-c2 text-3xl lg:text-4xl"></i>
            <i className="devicon-laravel-original dark:text-gray-200 text-c2 text-3xl lg:text-4xl"></i>
            <i className="devicon-typescript-plain dark:text-gray-200 text-c2 text-3xl lg:text-4xl"></i>
            <i className="devicon-nextjs-plain dark:text-gray-200 text-c2 text-3xl lg:text-4xl"></i>
            <i className="devicon-mongodb-plain dark:text-gray-200 text-c2 text-3xl lg:text-4xl"></i>
          ...
          <div className="mt-8 lg:mt-12 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            ...
            <button className="px-6 py-3 text-xs border-2  text-c2 border-dotted border-c2 font-semibold hover:bg-c3 hover:border-2 hover:border-c3 transition-all duration-300">
              Contact Me
            </button>
          </div>
        </div>
