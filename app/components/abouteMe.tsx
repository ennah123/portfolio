...
const AboutMe = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center w-full mt-15 px-4 py-16 bg-white dark:bg-c2">
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16 max-w-6xl w-full">
        
        <div className="text-center lg:text-left max-w-2xl">
          <h1 className="text-3xl dark:text-gray-200 text-c2 sm:text-4xl lg:text-5xl font-serif mb-2">
            OULDLAKHLIFA Ennah
          </h1>
          <p className="text-gray-600 dark:text-gray-300 text-lg sm:text-xl mb-8">Full-Stack Developer</p>
          
          <div className="w-20 h-1 bg-c1 mx-auto lg:mx-0 mt-4 mb-8"></div>
          
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-base text-sm mb-6 text-justify px-5">
          ...
          <p className="text-gray-700 leading-relaxed dark:text-gray-300 text-base text-sm mb-6 text-justify px-5">
          ...
          <div className="bg-c3 dark:bg-dc2 p-6 mt-8">
            <p className="text-gray-800 dark:text-gray-400 italic text-base text-sm">
              "I can seamlessly switch between frontend magic and backend logic!"
            </p>
          </div>

          <div className="flex justify-center mt-20">
            <div className="flex flex-col items-center justify-center gap-3 bg-c1 text-c2 w-32 h-28 hover:bg-dc2 dark:hover:text-gray-300 hover:text-white transition-all duration-200 cursor-pointer">
